...
#
# Options = {}
exports.attach = (connectServer, createAgent, options) ->
  options or= {}
  ...
  sjsServer.installApp {prefix: "/channel"}, (sock) ->
...
#          msg.meta = docData.meta
    ...
    createAgent data, (error, agent_) ->
      if error
        ...
        agent = agent_
        buff = new vertx.Buffer(JSON.stringify({auth:agent.sessionId}));
        sock.writeBuffer buff
