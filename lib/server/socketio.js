...
exports.attach = function(server, createClient, options) {
  ...
  io.of('/sjs').authorization(authClient).on('connection', function(socket) {
    ...
    handleOp = function(query, callback) {
      var op_data, _ref, _ref2;
      if (query.doc == null) throw new Error('No docName specified');
      if (!((query.v != null) || ((((_ref = query.meta) != null ? _ref.path : void 0) != null) && (((_ref2 = query.meta) != null ? _ref2.value : void 0) != null)))) {
    ...
    return socket.on('disconnect', function() {
      ...
      for (docName in docState) {
        ...
        state.busy = true;
        state.queue = [];
        if (state.listener != null) client.removeListener(docName);
      }
